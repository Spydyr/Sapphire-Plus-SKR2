...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  17.0815
    #define DEFAULT_Ki   1.6378
    #define DEFAULT_Kd  44.5378
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 109.2
  #define DEFAULT_bedKi 13.65
  #define DEFAULT_bedKd 582.1
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.0, 80.15, 400, 410 }
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 20000, 20000, 200, 3000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 22, -2.64 }
